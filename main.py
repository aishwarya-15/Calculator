...
from tkinter import *
def CreateWidgets():
    CalcDisplay = Entry(root,bd=10,justify='right',font=('arial',20,'bold'),width=25,textvariable=d_value,bg='cyan3')
    ...
    B_M = Button(root, text='X', bd=5, font=('arial', 20, 'bold'), width=4, height=2, command=lambda:buttonClick('*'))
    ...
    B_0 = Button(root, text='0', bd=5, font=('arial', 20, 'bold'), width=4, height=2, command=lambda:buttonClick('0'))
    B_0.grid(row=5, column=0, padx=5, pady=5)

    B_00 = Button(root, text='00', bd=5, font=('arial', 20, 'bold'), width=4, height=2, command=lambda:buttonClick('00'))
    B_00.grid(row=5, column=1, padx=5, pady=5)
